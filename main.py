...
input_file_path = os.path.join(dirname, "data/OUTPUT_FanHua.txt")
validation_data_length = 100
batch_size = 32
...
if __name__ == "__main__":
    ...
    lengths = [int(data_length - validation_data_length), validation_data_length]
